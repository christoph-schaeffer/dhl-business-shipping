...
namespace ChristophSchaeffer\Dhl\BusinessShipping\Response\Shipping\Data;
...
class ExportDocData {
    ...
    public function __construct($languageLocale, $exportDocDataResponse = NULL) {
        ...
        if(property_exists($exportDocDataResponse, 'Status'))
            $this->Status = ShippingStatusMapper::getStatusObjects($exportDocDataResponse->Status, $languageLocale);
