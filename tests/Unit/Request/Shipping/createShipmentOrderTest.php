...
class createShipmentOrderTest extends AbstractUnitTest {
    ...
    public function testConstructEmpty() {
        $request = new createShipmentOrder([]);
    ...
    public function testConstructMultiple() {
        ...
        $request = new createShipmentOrder([$shipmentOrder1, $shipmentOrder2, $shipmentOrder3]);
        $this->assertInstanceOf(Version::class, $request->Version);
        $this->assertNotEmpty($request->Version);
    ...
    public function testConstructSingle() {
        ...
        $request = new createShipmentOrder([$shipmentOrder]);
        $this->assertInstanceOf(Version::class, $request->Version);
        $this->assertNotEmpty($request->Version);
