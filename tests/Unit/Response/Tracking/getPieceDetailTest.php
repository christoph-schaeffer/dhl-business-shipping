...
class getPieceDetailTest extends AbstractUnitTest {
    public function testConstructWithCode100WithoutErrorResponse() {
        ...
        $responseEn = new Response\Tracking\getPieceDetail($request, $restResponse, 'rawRequestTest', 'en');
