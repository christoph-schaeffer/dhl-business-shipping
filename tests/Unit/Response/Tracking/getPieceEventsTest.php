...
class getPieceEventsTest extends AbstractUnitTest {
    ...
    public function testConstructWithCode100WithoutErrorResponse() {
        ...
        $responseEn = new Response\Tracking\getPieceEvents($request, $restResponse, 'rawRequestTest', 'en');
