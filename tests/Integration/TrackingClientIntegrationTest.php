...
class TrackingClientIntegrationTest extends AbstractIntegrationTest {
    ...
    public function testIntegrationGetPiece() {
        ...
        $languageLocale           = 'de';
        $expectedXmlRequestString = '<?xml version="1.0" encoding="ISO-8859-1" ?><data piece-code="'.$pieceCode.'" request="d-get-piece" appname="'.self::ZT_TOKEN.'" password="'.self::PASSWORD.'" language-code="'.$languageLocale.'"></data>';
